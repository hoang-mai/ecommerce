...
public interface ProductViewService {
    ...
    PageResponse<ProductViewDTO> searchProducts(Long shopId, Long categoryId, ProductStatus status, String keyword, int pageNo, int pageSize, String sortBy, String sortDir);

    ProductViewDTO getProductById(Long productId);
